...
void apilar(NodoPila *&pila, int n)
{
	NodoPila *n_nodo = new NodoPila();
	n_nodo->dato = n;
	n_nodo->Siguiente = pila;
	pila = n_nodo;

	cout << "\nElemento" << n << " agregar pila correctamente" << endl;
...
void Borrar(Lista *lista, int v) {
	...
	Leave a comment
		Adjunte archivos arrastrando y soltando, o pegándolos desde el portapapeles.Se admite el estilo con Markdown
